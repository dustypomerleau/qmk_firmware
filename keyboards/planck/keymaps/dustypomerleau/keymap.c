...
// Thanks for checking out my keymap - this is a Planck port of my Minidox keymap.
// The rationale behind the layout is described in my Minidox README.
// The 12 unused keys in the center columns and the corners can be repurposed for macros or anything else you choose.
...
[_SYS] = LAYOUT_planck_grid( \
  RESET,   DEBUG,   QWERTY,  CMK_DHM, _______, _______, _______, _______,  KC_VOLD, KC_VOLU, KC_BRID,  KC_BRIU, \
  KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, NAV_LK,  _______, _______, KC_POWER, VOL_DN,  VOL_UP,  KC__MUTE, KC_MPLY, \
